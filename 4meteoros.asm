...
SP_inicial_missil:            ; este é o endereço com que o SP deste processo deve ser inicializado
	...
	STACK 100H
SP_inicial_display_diminuir_tempo:
	
	STACK 100H
SP_inicial_display_aumentar_colisao_boa:
...
ciclo_missil:
	...
	CMP R3, 1
	JZ missil                    ; testa se houve explosao
...
colisao_disparo:
	...
	MOV R9, 3											; COnfirmar se funciona
	MOV [SELECIONA_SOM], R9									; confirmar se funciona
	MOV R9, linhas_meteoros
	MOV R1, [R9 + R8]
	MOV R9, colunas_meteoros
	MOV R2, [R9 + R8]
